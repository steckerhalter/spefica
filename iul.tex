...
% --- DIE NEUE SCHRIFT-ORDNUNG ---
\usepackage{tgpagella}      % Palatino-Klon: Modern, offen, elegant
\usepackage[T1]{fontenc}    % Korrekte Trennung und Sonderzeichen
\usepackage[scaled=0.92]{helvet} % Passende Sans-Serif für Akzente

% WICHTIG: mathptmx (Times) hier NICHT laden, sonst überschreibt es Pagella!

\usepackage{titlesec}
% Haupttitel: Kapitälchen & Sperrung
\titleformat{\section}
